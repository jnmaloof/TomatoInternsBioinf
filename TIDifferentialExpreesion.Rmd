...
* logConc: This is for the "refernce" condution of LYC.25.  It gives the log2 "concentration" of reads, calculated as log2(read counts in this gene / total read counts)
...
#### Exercise 8
Find the top genes differentially expressed in ARC relative to LYC by changing temperature.  Do a separate analysis to find genes cold induced/repressed genes in HAB relative to LYC.  How many genes are there in each analysis?
```{r}
